...
String password = "mysql";
     ...
     PreparedStatement pre1 = con.prepareStatement("SELECT photo_id FROM photos p INNER JOIN user u ON p.user_id=u.user_id where u.username=?");
	 ResultSet rs1=pre1.executeQuery();
	 while (rs1.next()) {
		    Array z = rs1.getArray("photo_id");
		    int[] zips = (int[])z.getArray();
