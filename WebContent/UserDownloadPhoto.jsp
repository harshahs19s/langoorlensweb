...
String suser = (String)sessionsa.getAttribute("userid1");
...
Time t;
	float price;
	PhotoArray(int photoid, Date d, Time t, float p)
	{
...
try {
	ps = con.prepareStatement("select * from download_history where user_id = "+suser);

	ResultSet rs=ps.executeQuery();
		while(rs.next())
		{		
			photo.add(new PhotoArray(rs.getInt(1),rs.getDate(3),rs.getTime(4),rs.getFloat(5)));
		}
	}
