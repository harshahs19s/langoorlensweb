							...
							<div class="span6" style="width: 100%">
								<div class="tabbable">
									<ul class="nav nav-tabs" id="myTab">
										...
										<li><a data-toggle="tab" href="#profile"> Debited <span
												class="badge badge-important"></span>
										</a></li>
										<li><a data-toggle="tab" href="#profile1"> All
												Transactions <span class="badge badge-important"></span>
										</a></li>
										...
										<div id="home" class="tab-pane in active">
											...
											<div class="row-fluid">
												<h3 class="header smaller lighter blue">
													Credited::Total Amount Credited <span class="green"><%=amount_credited %>
													</span> All Credits <span class="green"> <%=total_transactions_credited %></span>
												</h3>
												<div class="table-header">Results</div>
	   ...
	   while(rs1.next()){
							%>
										...
										<div id="profile" class="tab-pane">
											...
											<div class="row-fluid">
												<h3 class="header smaller lighter blue">
													Debited::Total Amount Debited <span class="green"><%=amount_debited %>
													</span> All Debits <span class="green"> <%=total_transactions_debited %></span>
