...
String suse = (String)sessionsa.getAttribute("userID");
String suser= request.getParameter("userID");
				...
				<ul class="nav nav-list">
					<li class="active">
						<a href="gallery.jsp">
							...
							<li >
								<a href="adminuserprofilepass?USER=<%=username%>">
...
<div class="page-header position-relative">
						<h5 style="color:white">
					    	...
					    	ResultSet rs1 = null;
					    		...
					    		try {
									ps1 = con1.prepareStatement("SELECT wallet FROM user where username=?");
...
//----------------------
	...
	try{   PreparedStatement stmt=con.prepareStatement("select idupload_history from upload_history where user_id = ? and status = 'expired' "); 
	        stmt.setString(1,suser);
	           PreparedStatement stmt1=con.prepareStatement("SELECT photo_id,valid_to,price from photos where photo_id = ?");
